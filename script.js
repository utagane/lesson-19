...
// Примечание: можно обращаться к каждому свойству 
// через цикл for/in, но методы объекта возвращать не нужно.

//решение через for/in
...
//решение через обычный return значений
city2.exportStr = function () {
    return `name = ${this.name}\npopulation = ${this.population}\n`;
};

console.log('Пример 2:'); //не понимаю почему выводит 3 параметром undefined ??
...
console.log(city1.getCity().population);
